...
def parse_args():
    ...
    overwrite_group.add_argument('--network/swin/fix_patch_proj', type=str2bool, default=argparse.SUPPRESS)
    overwrite_group.add_argument('--network/proj_head/num_layers', type=int, default=argparse.SUPPRESS)
    overwrite_group.add_argument('--network/proj_head/output_bn', type=str2bool, default=argparse.SUPPRESS)
    overwrite_group.add_argument('--network/proj_head/hidden_size', type=int, default=argparse.SUPPRESS)
    overwrite_group.add_argument('--dataset/root', type=str, default=argparse.SUPPRESS)
    ...
    overwrite_group.add_argument('--train/warmup_epochs', type=int, default=argparse.SUPPRESS)
    ...
    overwrite_group.add_argument('--train/clip_grad_norm', type=float, default=argparse.SUPPRESS)
